...
class NavigationFrame(customtkinter.CTkFrame):
    def __init__(self, master, select_frame_by_name, **kwargs):
        ...
        self.treeview_button.grid(row=1, column=0, sticky="ew",                 padx=1)
        ...
        self.chart_button.grid(row=2, column=0, sticky="ew",                    padx=1)
...
class ToolBarFrame(customtkinter.CTkFrame):
    def __init__(self, master, chart_frame, **kwargs):
        ...
        self.grid_rowconfigure((0,9), weight=1, uniform='a')

        self.toolbar_frame_label = customtkinter.CTkLabel(master=self, text='Toolbar', anchor='center', fg_color='transparent',
                                        font=customtkinter.CTkFont(size=25, weight='bold'))
        # self.toolbar_frame_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20, sticky='news')
        self.toolbar_frame_label.grid(row=0, column=0, columnspan=2, padx=10, pady=10, sticky='news')
        ...
        self.switch_yscale.grid(row=1, column=0, sticky='news',                 padx=(5,5), pady=10)
        ...
        self.btc_halving_dates_checkbox.grid(row=1, column=1, stick='news',     padx=(5,5), pady=10)


        self.previous_crypto_button = customtkinter.CTkButton(master=self, corner_radius=0, height=10, text="Previous", fg_color="transparent",
                            text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), command=self.previous_crypto_button_event)
        self.previous_crypto_button.grid(row=9, column=0, sticky="news",       pady=(10,50))

        self.next_crypto_button = customtkinter.CTkButton(master=self, corner_radius=0, height=10, text="Next", fg_color="transparent",
                            text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), command=self.next_crypto_button_event)
        self.next_crypto_button.grid(row=9, column=1, sticky="news",            pady=(10,50))


        self.can_delet_label_0 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_0.grid(row=2, column=0, columnspan=2, sticky='news',                 pady=10)

        self.can_delet_label_1 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_1.grid(row=3, column=0, columnspan=2, sticky='news',                 pady=10)

        self.can_delet_label_2 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_2.grid(row=4, column=0, columnspan=2, sticky='news',                 pady=10)

        self.can_delet_label_3 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_3.grid(row=5, column=0, columnspan=2, sticky='news',                 pady=10)

        self.can_delet_label_4 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_4.grid(row=6, column=0, columnspan=2, sticky='news',                 pady=10)

        self.can_delet_label_5 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_5.grid(row=7, column=0, columnspan=2, sticky='news',                 pady=10)

        self.can_delet_label_6 = customtkinter.CTkLabel(master=self, text='widget', anchor='center', fg_color='green',
                                        font=customtkinter.CTkFont(size=15, weight='bold'))
        self.can_delet_label_6.grid(row=8, column=0, columnspan=2, sticky='news',                 pady=10)



    def next_crypto_button_event(self):
        pass

    def previous_crypto_button_event(self):
        pass
